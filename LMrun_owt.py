...
if __name__ == "__main__":
    check_point_addr = "remote/owt_6500_3.71/check_point_epoch6500.sav"
    tokenizer_vocab = "trained_values/openwebtext_success/vocab_final.pkl"
    tokenizer_merge = "trained_values/openwebtext_success/merges_final.pkl"
